...
<head>
    ...
    <!-- Title Page-->
    <title>BSBA Faculty Scheduling</title>
    <link rel="icon" href="assets/uploads/BSBA.jpg" type="image/png">
    ...
    <div class="page-wrapper">
        ...
        <header class="header-mobile d-block d-lg-none">
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    ...
                    <img src="assets/uploads/back.png"style="height: 50px; width: 50px;" alt="BSBA Faculty Scheduling"  />
                    BSBA Faculty Scheduling
</div>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                    ...
                    <img src="assets/uploads/BSBA.jpg"style="height: 45px; width: 45px; margin-left: -10%;" alt=" BSBA Faculty Scheduling"  />
                    BSBA Faculty Scheduling
